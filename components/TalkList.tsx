...
// console.log('propppp', talks)
//   let title = 'Our conference talks';

//   if (classification) {
//     const devClass = classification['72ba66d0-0478-4d62-9ef4-5461c89b1ffc'];
//     const mktClass = classification['0d77df8f-a903-4163-befb-008bd061d454'];

//     // score = 0 - developer
//     // score = 1 - marketer
//     // score = undefined - unknown
//     let score = undefined;
//     if (devClass > 0 || mktClass > 0) {
//       score = devClass > mktClass ? 0 : 1;
//     }

//     title = score !== undefined ? 'Conference talks for you' : title;

//     if (score === 0) {
//       talks = developerTalks;
//     } else if (score === 1) {
//       talks = marketerTalks;
//     }
//   }
...
const TalkListItem: React.FC<Entry<ITalkFields> & { buttonText: string }> = (props) => {
  ...
  if (unfrmOptIntentTag) {
    intents = Object.keys(unfrmOptIntentTag?.intents?.auto);
  }
